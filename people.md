...
{% assign role_array = "pi|postdoc|phd|undergrad|visiting|others|alumni" | split: "|" %}
      ...
      <div class="list-item-people">
        <p class="list-post-title">
          {% if profile.avatar %}
            ...
            <a href="{{ profile.webpage }}"  target="_blank"><img class="profile-thumbnail" src="{{site.baseurl}}/images/people/{{profile.avatar}}"></a>
          {% else %}
          ...
          <!-- <a class="name" href="{{ site.baseurl }}{{ profile.url }}">{{ profile.name }}</a> -->
            <a class="name" href="{{ profile.webpage }}" target="_blank">{{ profile.name }}</a>
        </p>
      </div>    
    {% endif %}
  {% endfor %}
